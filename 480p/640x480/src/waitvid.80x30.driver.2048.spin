...
'' 20190716: adapted for 640x480@60Hz, C0DF conversion preserved despite having no effect
''
CON
  CURSOR_ON    = %100
  CURSOR_OFF   = %000
...
'                               | |     +-------- back porch
'                               | |     |
vsync           mov     ecnt, #10+2+(33-4)

                cmp     ecnt, #31 wz
        if_ne   cmp     ecnt, #29 wz
...
wrap            long     96 << 12 | 144         '  96/144
hvis            long      1 << 12 | 8           '   1/8
line            long    160 << 12 | 640         ' 160/640
many            long      0 << 12 | 3200        ' 256/3200
...
pmsk_0          long    %%0000_0000_0000_1333   ' |
pmsk_1          long    %%0000_1333_0000_0000   ' xor mask for underscore cursor (secondary inactive)
